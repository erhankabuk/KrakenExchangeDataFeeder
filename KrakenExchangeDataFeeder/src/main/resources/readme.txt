...
This microservice provides OHLC datas via Kraken API.

Currencies saved as json file in local database.

For more informations please visit https://www.kraken.com/features/api

Warnings:
-Check and change application.properties as needs.
    As data source, local time, hibernate settings etc.
...
Get OHLC data from Kraken please checkout URL: https://www.kraken.com/features/api#get-ohlc-data
